...
public class HW6 extends HttpServlet {
   public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        out.println ("<html>");       
        out.println ("<head>");
        out.println ("<title>SWE 642 HW6 Restaurant</title>");
        out.println ("</head>");        
        out.println ("<body>");        
        out.println ("<h1 align=\"center\">SWE 642 HW6 Restaurant -- Ming Zhang</h1>");
        ...
        out.println ("<form method=\"get\" action=\"http://apps-swe642.vse.gmu.edu:8080/swe642/servlet/mzhang8.HW6Review\">");
    ...
    public void doPost (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {    	
    	...
    	if(bname && bstreet && bcity && bstate && bzcode && byear && bmonth && bday) {   	
	    	...
	    	RestInfo newReview = new RestInfo(rName, fType, street, city, state, zCode, year, month, day, rate, comment);
    		...
    		toClient.println ("<html>");       
    		toClient.println ("<head>");
    		toClient.println ("<title>SWE 642 HW6 Restaurant</title>");
    		toClient.println ("</head>");        
    		toClient.println ("<body>");        
    		toClient.println ("<h1 align=\"center\">SWE 642 HW6 Restaurant -- Ming Zhang</h1>");
    		...
    		toClient.println ("<hr>");       
            toClient.println ("<div align=\"center\">");
            toClient.println ("<form method=\"get\" action=\"http://apps-swe642.vse.gmu.edu:8080/swe642/servlet/mzhang8.HW6Review\">");
    ...
    private void drawForm(PrintWriter out) {        
        out.println ("<div align=\"center\">");
        out.println ("<form method=\"post\" action=\"http://apps-swe642.vse.gmu.edu:8080/swe642/servlet/mzhang8.HW6\">");

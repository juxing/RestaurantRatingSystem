<%@page language="java"%>
<%@page import="mzhang8.RestValidatorBean"%>
<jsp:useBean id="rValBean" class="mzhang8.RestValidatorBean" scope="page"/>
...
<html>
  <head>
    <title>SWE 642 HW7 Restaurant</title>
  </head>
  <body>
    <h1 align="center">SWE 642 HW7 Restaurant -- Ming Zhang</h1>
    ...
    <hr>    
    <div align="center">
    <form method="post" action="http://apps-swe642.vse.gmu.edu:8080/swe642/jsp/mzhang8/HW7Validate.jsp">
      <table>
        <tr>
    ...
    <hr>
    <div align="center">
    <form method="get" action="http://apps-swe642.vse.gmu.edu:8080/swe642/jsp/mzhang8/HW7Review.jsp">

<%@page language="java"%>
<%@page import="mzhang8.RestUpdateBean"%>
<%@page import="mzhang8.RestInfo"%>
<jsp:useBean id="rUpdateBean" class="mzhang8.RestUpdateBean" scope="page"/>
<jsp:setProperty name="rUpdateBean" property="*"/>

<html>       
  <head>
    <title>SWE 642 HW7 Restaurant Update</title>
  </head>           
  
  <%if(rUpdateBean.getRestaurantName() == null) {
      RestInfo r = rUpdateBean.getUpdateReview();%>
      
  <body>        
    <h1 align="center">SWE 642 HW7 Restaurant Update -- Ming Zhang</h1>
    ...
    <%} else {
	  ...
	  <body bgcolor="#EEEEEE">
	    <center><h2>SWE 642 HW7 Restaurant Update -- Ming Zhang</h2></center>
	    <hr>
	    <div align=center>
	    <table border=0>
	      <tr bgcolor="#C0C0C0">

<%@page language="java"%>
<%@page import="mzhang8.RestCloneBean"%>
<%@page import="mzhang8.RestInfo"%>
<jsp:useBean id="rCloneBean" class="mzhang8.RestCloneBean" scope="page"/>
<jsp:setProperty name="rCloneBean" property="*"/>

<html>       
  <head>
    <title>SWE 642 HW7 Restaurant Clone</title>
  </head>           
  
  <%RestInfo r = rCloneBean.getCloneReview();%>
      
  <body>        
    <h1 align="center">SWE 642 HW7 Restaurant Clone -- Ming Zhang</h1>

...
public class HW8RestUpdateBean {
	...
	public HW8RestUpdateBean() throws IOException {
	...
	public void setPrivacy(String pri) {
		privacy = pri;
	}
	...
	public HW8RestInfo getUpdateReview() {
	...
	public void validate() throws IOException {
		...
		if(bname && bstreet && bcity && bstate && bzcode && byear && bmonth && bday) {
			String fileName = "/data/swe642fall2013/swe642/resources/mzhang8/HW8restaurants.xml";
	    	ArrayList<HW8RestInfo> reviews = null;
	    	HW8XMLData data = new HW8XMLData();
	    	if(!((new File(fileName)).exists())) {
	    		reviews = new ArrayList<HW8RestInfo>();
	    		FileWriter datafile = new FileWriter (fileName);
	    	...
	    	HW8RestInfo newReview = new HW8RestInfo(restaurantName, foodType, street, city, state, zipCode, year, month, day, rate, comment, privacy, owner);
